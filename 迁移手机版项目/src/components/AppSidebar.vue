...
<template>
  ...
  <aside
    class="hidden md:flex bg-white dark:bg-[#141413] border-r border-gray-100 dark:border-[#2e2e2c] flex-col overflow-hidden transition-[width] duration-300 ease-out"
