        ...
        >
          ...
          <div class="px-6 py-7 sm:px-8">
            <template v-if="view === 'learn'">
              ...
              <div v-else class="space-y-5 break-words">
                <div>
            ...
            <template v-else>
              ...
              >
                ...
                <div class="border-t border-current/10 pt-4 text-[#141413] dark:text-[#faf9f5]">
                  ...
                  <div class="mt-3 break-words" v-html="cleanHtml(currentWord.meaning)" />
                  <div v-if="currentWord.exampleEn" class="mt-4">
                    <h3 class="mb-1 text-xs font-bold text-[#888]">英语例句</h3>
                    <div class="break-words leading-7" v-html="cleanHtml(currentWord.exampleEn)" />
                  </div>
                  <div v-if="currentWord.exampleZh" class="mt-4">
                    <h3 class="mb-1 text-xs font-bold text-[#888]">例句翻译</h3>
                    <div class="break-words leading-7" v-html="cleanHtml(currentWord.exampleZh)" />
                  </div>
                  <div v-if="currentWord.note" class="mt-4">
